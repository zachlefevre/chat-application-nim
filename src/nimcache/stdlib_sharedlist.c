...
N_NIMCALL(SharedList_9cWkTIPQvNw7gFHMOEzMCLw, initSharedList_ftyWlQN9a0f9cDyTF3NRz9cTg)(void) {
	SharedList_9cWkTIPQvNw7gFHMOEzMCLw result;
...
N_NIMCALL(void, add_LMD14ZZveJ1hTQDkuvr6bQ)(SharedList_9cWkTIPQvNw7gFHMOEzMCLw* x, void* y) {
	SharedListNodecolonObjectType__82xHhBDm9bpijSPOyEGz0Hw* node;
	acquire_9bBEZeGCRkWQl9bLT1qt423Q((&(*x).lock));
	node = (SharedListNodecolonObjectType__82xHhBDm9bpijSPOyEGz0Hw*)0;
	{
		NIM_BOOL T3_;
		void* T7_;
		T3_ = (NIM_BOOL)0;
		...
		if (!T3_) goto LA5_;
		T7_ = (void*)0;
		T7_ = allocShared0_sVm4rDImKK2ZDdylByayiA_3(((NI) (((NI)sizeof(SharedListNodecolonObjectType__82xHhBDm9bpijSPOyEGz0Hw)))));
		node = ((SharedListNodecolonObjectType__82xHhBDm9bpijSPOyEGz0Hw*) (T7_));
		(*node).next = (*x).tail;
		(*x).tail = node;
		{
