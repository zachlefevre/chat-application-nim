...
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_5, "\015\012  0 <= toCopy ", 16);
...
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_34, "\015\012  0 < bufLen ", 15);
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_35, "\015\012  not (input == nil) ", 23);
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_39, "", 0);
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_41, "\015\012", 2);
STRING_LITERAL(TM_k6p5NxDJat9aTyZxfZjCDJQ_42, "^\015\012", 3);
...
appendString(result, ((NimStringDesc*) &TM_k6p5NxDJat9aTyZxfZjCDJQ_41));
	nimln_(175, "lexbase.nim");
	{
		...
		T7_ = rawNewString(T9_->Sup.len + 3);
